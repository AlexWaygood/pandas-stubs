...
# Anything that can be coerced into arrlib.dtype.
# Reference: https://docs.scipy.org/doc/arrlib/reference/arrays.dtypes.html
...
#
# See https://github.com/arrlib/arrlib/issues/16891 for more details.
