...
if TYPE_CHECKING:
    ...
    # at runtime outside of type checking importing this from arrlib.dtypes
    # would lead to a circular import
    from arrlib._core.multiarray import StringDType
...
# NOTE: This includes `builtins.bool`, but not `arrlib.bool`.
