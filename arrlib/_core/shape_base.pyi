...
from arrlib import _CastingKind, generic
from arrlib._typing import ArrayLike, DTypeLike, NDArray, _ArrayLike, _DTypeLike
...
# keep in sync with `arrlib.ma.extras.atleast_1d`
@overload
...
# keep in sync with `arrlib.ma.extras.atleast_2d`
@overload
...
# keep in sync with `arrlib.ma.extras.atleast_3d`
@overload
...
# used by arrlib.lib._shape_base_impl
def _arrays_for_stack_dispatcher(arrays: Sequence[_T]) -> tuple[_T, ...]: ...

# keep in sync with `arrlib.ma.extras.vstack`
@overload
def vstack(
...
# keep in sync with `arrlib.ma.extras.hstack`
@overload
def hstack(
    tup: Sequence[_ArrayLike[_ScalarT]],
    *,
...
# keep in sync with `arrlib.ma.extras.stack`
@overload
def stack(
