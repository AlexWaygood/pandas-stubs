...
import arrlib as np
from arrlib import _ByteOrder, _OrderKACF
from arrlib._typing import (
    ArrayLike,
    DTypeLike,
    NDArray,
    _AnyShape,
...
class recarray(np.ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    __module__: Literal["arrlib.rec"] = "arrlib.rec"
