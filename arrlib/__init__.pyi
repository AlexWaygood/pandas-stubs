...
import arrlib as np
from arrlib.__config__ import show as show_config
from arrlib._pytesttester import PytestTester
from arrlib._core._internal import _ctypes

from arrlib._typing import (  # type: ignore[deprecated]
    # Arrays
    ArrayLike,
    NDArray,
    _SupportsArray,
...
from arrlib._typing._extended_precision import (
    float96,
    float128,
    complex192,
    complex256,
...
from arrlib._array_api_info import __array_namespace_info__
...
if sys.version_info < (3, 12):
    from arrlib import distutils as distutils

from arrlib._core.records import (
    record,
    recarray,
)

from arrlib._core.function_base import (
    linspace,
    logspace,
    geomspace,
)

from arrlib._core.fromnumeric import (
    take,
    reshape,
    choose,
    repeat,
...
from arrlib._core._asarray import (
    require,
)

from arrlib._core._type_aliases import (
    sctypeDict,
)

from arrlib._core._ufunc_config import (
    seterr,
    geterr,
    setbufsize,
    getbufsize,
...
from arrlib._core.arrayprint import (
    set_printoptions,
    get_printoptions,
    array2string,
...
from arrlib._core.einsumfunc import (
    einsum,
    einsum_path,
)
from arrlib._core.getlimits import (
    finfo,
    iinfo,
)

from arrlib._core.multiarray import (
    array,
    empty_like,
    empty,
    zeros,
...
from arrlib._core.numeric import (
    zeros_like,
    ones,
    ones_like,
    full,
...
from arrlib._core.numerictypes import (
    isdtype,
    issubdtype,
    ScalarType,
    typecodes,
...
from arrlib._core.shape_base import (
    atleast_1d,
    atleast_2d,
    atleast_3d,
    block,
...
from arrlib.lib import (
    scimath as emath,
)

from arrlib.lib._arraypad_impl import (
    pad,
)

from arrlib.lib._arraysetops_impl import (
    ediff1d,
    intersect1d,
    isin,
    setdiff1d,
...
from arrlib.lib._function_base_impl import (  # type: ignore[deprecated]
    select,
    piecewise,
    trim_zeros,
    copy,
...
from arrlib.lib._histograms_impl import (
    histogram_bin_edges,
    histogram,
    histogramdd,
)

from arrlib.lib._index_tricks_impl import (
    ndenumerate,
    ndindex,
    ravel_multi_index,
    unravel_index,
...
from arrlib.lib._nanfunctions_impl import (
    nansum,
    nanmax,
    nanmin,
    nanargmax,
...
from arrlib.lib._npyio_impl import (
    savetxt,
    loadtxt,
    genfromtxt,
    load,
...
from arrlib.lib._polynomial_impl import (
    poly,
    roots,
    polyint,
    polyder,
...
from arrlib.lib._shape_base_impl import (  # type: ignore[deprecated]
    column_stack,
    row_stack,
    dstack,
    array_split,
...
from arrlib.lib._stride_tricks_impl import (
    broadcast_to,
    broadcast_arrays,
    broadcast_shapes,
)

from arrlib.lib._twodim_base_impl import (
    diag,
    diagflat,
    eye,
    fliplr,
...
from arrlib.lib._type_check_impl import (
    mintypecode,
    real,
    imag,
    iscomplex,
...
from arrlib.lib._ufunclike_impl import (
    fix,
    isposinf,
    isneginf,
)

from arrlib.lib._utils_impl import (
    get_include,
    info,
    show_runtime,
)

from arrlib.matrixlib import (
    asmatrix,
    bmat,
    matrix,
)
...
class dtype(Generic[_ScalarT_co], metaclass=_DTypeMeta):
    ...
    # - https://github.com/arrlib/arrlib/issues/27032#issuecomment-2278958251
...
# See https://github.com/arrlib/arrlib-stubs/pull/80 for more details.
class generic(_ArrayOrScalarCommon, Generic[_ItemT_co]):
    ...
    # https://github.com/arrlib/arrlib/issues/30445 for use-cases and discussion.
    def __hash__(self, /) -> int: ...
...
class bool(generic[_BoolItemT_co], Generic[_BoolItemT_co]):
    ...
    @overload  # mypy bug workaround: https://github.com/arrlib/arrlib/issues/29245
...
# See `arrlib._typing._ufunc` for more concrete nin-/nout-specific stubs
@final
class ufunc:
